...
const Index = () => (
    <>
        <Head>
            <title key={'title'}>
                Rowan & Raven Yarn | Every colour has a story
            </title>
            <meta
                name='description'
        ...
        <main className={'layout'}>
            ...
            <div>
                ...
                <p>
                    Nadia may be around on Instagram from time to time by that
                    name if you’d like to stay in touch :) So long and thanks
                    for all the fish!
                </p>
